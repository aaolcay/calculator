...
int main(){
    ...
    switch(islem){/** switch yapılacak operation'ı belirler **/
    ...
    case 1:
        ...
        scanf("%f",&tutar);
            if(tutar>bakiye){
                ...
                scanf("%s",&cevap);
                if(strcmp(cevap, "evet") == 0){/** string ifade için if conditional **/
                    printf("\nIsleminiz Onaylanmistir");
                    kalan=bakiye-tutar;
                    /**
                    bakiye -= tutar; aynı işlemi yapar
    ...
    default: /** Hiçbir case'e girmezse default'a girer **/
